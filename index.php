...
<head>
    ...
    left: 0;
    z-index: 20;
    background: lightgreen center no-repeat;
    text-align:center;
        }
...
<div id="lock"><img src="image/PngItem_5146697.png" alt="" style="width:50%; margin-top:50%;"><br>
...
<div id="container">
    ...
    <div class="container-large"
        style="color:white; height:500px; width: 100%; padding:8% 2% 2% 2%; background-color:lightgreen;">
        <div class="row">
            ...
            <div class="col" style="margin:4% 0% 0% 5%; text-align:center;">
                &nbsp;<img src="image/money1.png" class="zoomin" alt="" style="width:0px;">
            </div>
        </div>
    </div>
    <img src="image/abstbg2.png" alt="" style="width:100%; position:absolute; z-index:-1">
        ...
        <div class="container"
            ...
            <div class="container" style="margin:30px 0px 20px 0px;">
                <div class="row">
                    <div class="col-lg">
                        <div
                            style="background-color:pink; color:white; width: 90%; border-radius:30px; box-shadow:3px 3px 8px gray; padding:20px 10px 20px 10px;">

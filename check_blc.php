    ...
    <center>
        <div class="container" style="margin-top: 10%; padding:10px 80px 10px 80px; ">
            <div
                ...
                <h1 style=" color:red;">Check Account Balance</h1>
            </div>
            ...
            <div class="container"
                ...
                <form action="check_blc.php" method="post">
                    <input type="text" class="formin form-control" name="accno" id="" placeholder="Account Number" style="background-color: pink;"><br>
                    <br><input class="btn mybtn btn-outline-light" type="submit" value="Submit" style="background-color: orange;" ><br><br>
                    <p style=color:blue;>Don't remember your account number? check <a href="all_cust.php">here</a>
                    </p>
                </form>
            </div>
        </div>

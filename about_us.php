...
<body style="background-color:lightgreen;">
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            ...
            <br><br>
            <img src="image/Muskan.jpeg" alt="" style="width:20%; box-shadow:2px 2px 15px black;">
            <br><br>
            <p style="color:blue;">This website is created by</p>
            <h1 style="color:blue; text-shadow:2px 2px 2px gray;">Muskan Kulshreshtha</h1>
            <p style="color:black;"><b>Intern at Sparks Foundation <br> Dayalbagh Educational Institute, Agra</b></p>
    </center>

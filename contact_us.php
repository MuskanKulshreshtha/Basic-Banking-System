...
<body style="background-image:url('image/success 1.jpg'); padding-top:8%;">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed fixed-top"
        ...
        <div class="container-fluid">
            <a href="index.php"><img src="image\logo_small.png" alt=""style="height: 80px; margin-left:25px; margin-top:10px;"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <b>
                <ul class="navbar-nav ">
                    ...
                    <li class="nav-item" style="margin-left:15px;">
                        <a class="nav-link text-nowrap" href="all_cust.php">Customers Details</a>
                    </li>
                    <li class="nav-item" style="margin-left:15px;">
...
?>
    ...
    <center>
        <div class="container" style="padding:10px 80px 10px 80px; margin-top:2%;">
            <div
                style="width:80%; background-color:yellow; padding:5px 5px 5px 5px; border-radius:30px; box-shadow: 2px 2px 10px gray;">
            ...
            <div class="container"
                ...
                <form action="contact_us.php" method="post">
                    <input type="text" class="formin form-control" name="name" id="" placeholder="Name" style= "background-color:pink;" ><br><br>
                    <input type="email" class="formin form-control" name="email" id="" placeholder="Email" style= "background-color:pink;"><br><br>
                    <textarea name="message" class="" style="border-radius:20px; padding: 5px 5px 5px 15px; background-color:pink"
                        placeholder="Enter your message" rows="5" cols="47" id=""></textarea>
                    <br><br><input class="btn mybtn btn-outline-light" type="submit" value="Submit" style= "background-color:orange;">
                </form>
            </div>
        </div>
